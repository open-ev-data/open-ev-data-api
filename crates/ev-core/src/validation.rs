...
mod tests {
    ...
    fn test_validate_slug_valid() {
        assert!(validate_slug("tesla").is_ok());
        assert!(validate_slug("model_3").is_ok());
        assert!(validate_slug("byd_dolphin_2024").is_ok());
    }

    #[test]
    fn test_validate_slug_invalid() {
        assert!(validate_slug("").is_err());
        assert!(validate_slug("Tesla").is_err());
        assert!(validate_slug("model-3").is_err());
        assert!(validate_slug("model 3").is_err());
    }
